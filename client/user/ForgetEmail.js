    ...
    return (
      ...
      <Card style={{ width:"400px",height:"500px" }} >
        <CardContent >
          ...
          <TextField id="mailid" type="email"  value={this.state.email} label="Enter Your E-mail"  margin="normal"   onChange={this.handleChange('email')}/><br/>
        </CardContent>
        <CardActions style={{ float:"right" }}>
          <Button color="secondary" variant="raised" onClick={this.clickSubmit} >send Confirmation</Button>
        </CardActions>
        <CardContent>
        <Snackbar
          anchorOrigin={{
